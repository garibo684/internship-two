...
/*
 * @def_group CRCL_Values
 *
 */
#define SPI_CRCL_8BIT				( (uint32_t)(0x00000000) )
#define SPI_CRCL_16BIT				( (uint32_t)(0x00000800) )
...
typedef struct
{
	...
	uint32_t FrameFormat;	/* FrameFormat Values for SPI @def_group FF_Values			*/
	uint32_t CRCL;			/* CRC length Values for SPI @def_group CRCL_Values			*/
